		...
		if(email!=null || !email.equals("")) {
			...
			Session session = Session.getDefaultInstance(props, new javax.mail.Authenticator() {
				protected PasswordAuthentication getPasswordAuthentication() {
					return new PasswordAuthentication("spuneetsingh36@gmail.com", "zmpxpqvnbyosgaqx");// Put your email
																									// id and
																									// password here
				}
			});
			...
			try {
				...
				message.setFrom(new InternetAddress("spuneetsingh36@gmail.com"));// change accordingly
