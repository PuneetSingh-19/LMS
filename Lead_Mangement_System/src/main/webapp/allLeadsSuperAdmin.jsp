				...
				count = rs1.getInt("id");
				 ...
				 /* for (int a = 1; a <= count; a++) {  */
							...
							while (rs.next()) {
								...
								out.print("<td><form action ='allLeadsSuperAdmin' method = 'post'><button type = 'submit' class = 'btn btn-danger' name = 'delete' value = '+ "+email+"+' onclick='myFunction()'>Delete</button></form></td>");
